...
pub fn render_settings(ctx: &TenantContext, message: Option<String>) -> Html {
                            ...
                            <div class="sm:col-span-4">
                                ...
                                <div class="mt-1 flex items-center space-x-3">
                                    ...
                                    <input type="text" value="{{primary_color}}" readonly 
                                        class="bg-gray-50 dark:bg-gray-700 border border-gray-300 rounded-md px-3 py-2 text-sm w-32 dark:text-white transition-colors">
                                </div>
                            </div>
                        ...
                        <div class="pt-5 border-t dark:border-gray-700">
                            <div class="flex justify-end">
                                <a href="/t/{{tenant_slug}}/dashboard" 
                                    class="bg-white dark:bg-gray-700 py-2 px-4 border border-gray-300 dark:border-gray-600 rounded-md text-sm font-medium text-gray-700 dark:text-gray-200 mr-3 transition-colors">Cancel</a>
