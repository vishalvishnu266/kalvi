...
pub fn login_page(tenant_slug: &str, error: Option<String>) -> Html {
    ...
    let content = html!(
        // language=html
        r#"<div class="min-h-full flex flex-col justify-center py-12 sm:px-6 lg:px-8">
            <div class="sm:mx-auto sm:w-full sm:max-w-md">
                <h2 class="mt-6 text-center text-3xl font-extrabold text-gray-900">Sign in to your account</h2>
                <p class="mt-2 text-center text-sm text-gray-600">
                    Institution: <span class="font-medium text-indigo-600">"#, e(tenant_slug), r#"</span>
                </p>
            </div>
            ...
            <div class="mt-8 sm:mx-auto sm:w-full sm:max-w-md">
                <div class="bg-white py-8 px-4 shadow sm:rounded-lg sm:px-10">"#,
                    error_alert,
                    r#"<form class="space-y-6" action="/t/"#, e(tenant_slug), r#"/login" method="POST">
                        <div>
