//! Core student model and shared DB helpers.
//!
//! These items are intentionally kept even when unused, as they form
//! the public foundation for future student-management features.
