...
const LAZY_MAP = {
  ...
  // `ui-copilot` is intentionally NOT registered here yet — it will be
  // rebuilt in milestone 8 as a lean SSE-driven agent shell. Legacy
  // copilot-v2 has been removed.
};
