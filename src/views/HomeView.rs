...
pub fn render_home() -> Html {
    // language=html
    let template = r#"
        <div class="min-h-full flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8 bg-gray-50 dark:bg-gray-900 transition-colors duration-200">
            <div class="max-w-md w-full space-y-8">
                <div class="text-center">
                    <i data-lucide="graduation-cap" class="h-16 w-16 text-indigo-600 mx-auto"></i>
                    <h2 class="mt-6 text-4xl font-extrabold text-gray-900 dark:text-white">School ERP</h2>
                    <p class="mt-2 text-sm text-gray-600 dark:text-gray-400">Multi-tenant Education Management System</p>
                </div>
                    ...
                    <div class="{{CARD}} text-center space-y-6">
                        ...
                        <div class="relative py-4">
                            ...
                            <div class="relative flex justify-center text-sm">
                                <span class="px-2 bg-white dark:bg-gray-800 text-gray-500">Existing Users</span>
                            </div>
                        </div>

                        <p class="text-sm text-gray-600 dark:text-gray-400">
                            Already registered? Visit your institution's custom URL:<br>
                            <code class="bg-gray-100 dark:bg-gray-700 px-2 py-1 rounded text-indigo-700 dark:text-indigo-400 font-mono text-xs mt-2 inline-block">
                                /t/&lt;your-slug&gt;/login
                            </code>
                        </p>
                    </div>
    ...
    base("School ERP - Home", Html::new("".into()), content)
}
