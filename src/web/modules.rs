...
fn stubs() -> &'static [ModuleStub] {
    &[
        ModuleStub {
            ...
            features: &[
                "Class-wise daily marking",
                "Bulk import from biometric devices",
                "Monthly attendance reports",
                "Parent notifications for absentees",
            ],
        },
        ModuleStub {
            key: "timetable",
        ...
        ModuleStub {
            ...
            features: &[
                ...
                "Recurring invoices per term",
                "Online payments with reconciliation",
                "Dues aging and reminders",
            ],
        },
        ModuleStub {
            key: "examinations",
        ...
        ModuleStub {
            ...
            features: &[
                "Broadcast notices",
                "Targeted messages by class/section",
        ...
        ModuleStub {
            ...
            features: &[
                "Book catalogue with ISBN",
                "Barcode issue / return",
        ...
        ModuleStub {
            ...
            features: &[
                "Actor, timestamp, and diff for every change",
...
stub_handler!(
    examinations,
    "examinations",
    perm::EXAMINATIONS_VIEW,
    perm::EXAMINATIONS_ENTER_MARKS
);
...
stub_handler!(
    communication,
    "communication",
    perm::COMMUNICATION_VIEW,
    perm::COMMUNICATION_BROADCAST
);
